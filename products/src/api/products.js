...
module.exports = (app,channel) => {
    ...
    app.put('/wishlist',UserAuth, async (req,res,next) => {
        ...
        try {
            const {data} =await service.GetProductPayload(_id,req.body._id,1,'ADD_TO_WISHLIST');
            ...
            console.log("Error while put request")
        }
    });
    ...
    app.put('/cart',UserAuth, async (req,res,next) => {
        ...
        try {     
            const {data} = await service.GetProductPayload(_id, req.body._id, req.body.qty, 'ADD_TO_CART')
